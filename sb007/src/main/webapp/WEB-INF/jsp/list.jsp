...
<DL class="search clearfix">
  ...
  <UL>
    ...
    <LI>标题：<INPUT class=text type=text name=name value="${vo.name}"> <LABEL class=ui-blue><INPUT onclick=doSearch() value=搜索房屋 type=submit name=search></LABEL>
    </LI></UL></DT>
  <DD>
  <UL>
  ...
  <UL>
    ...
    <LI><SELECT name=floorage> <OPTION ${vo.floorage == ""?"selected":""}  value="">不限</OPTION> <OPTION
      ...
      value=500-1000000 ${vo.floorage == "500-1000000"?"selected":""}>500以上</OPTION></SELECT> </LI></UL>
  </DD>
  ...
  <TR class=odd>
    ...
    <TD>
      <DL>
        ...
        <DD>${house.HLoc1}${house.HLoc2},${house.HRect}平米<BR>联系方式：ff </DD></DL></TD>
