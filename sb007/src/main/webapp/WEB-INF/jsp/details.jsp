...
<DIV class=intro>
<DIV class=lefter>
<H1>${hDetails.HName}</H1>
<DIV class=subinfo><fmt:formatDate value='${hDetails.HDate}' pattern='yyyy-MM-dd'/></DIV>
<DIV class=houseinfo>
<P>户　　型：<SPAN>一室一厅</SPAN></P>
<P>面　　积：<SPAN>${hDetails.HRect}m<SUP>2</SUP></SPAN></P>
<P>位　　置：<SPAN>${hDetails.HLoc1},${hDetails.HLoc2}</SPAN></P>
